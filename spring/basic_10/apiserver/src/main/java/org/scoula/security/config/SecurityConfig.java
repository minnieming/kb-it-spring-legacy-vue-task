...
public class SecurityConfig extends WebSecurityConfigurerAdapter { // spring security를 위한 기본 골격으로 Extends 함.
    ...
    public void configure (HttpSecurity http) throws Exception {
        ...
        http.httpBasic().disable()
                        ...
                        .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS); // session의 생성 모드를 stateless 모드로 설정
...
//                .roles("MEMBER");
        ...
        auth
                .userDetailsService(userDetailsService) // userdetailsservice 빈 등록
